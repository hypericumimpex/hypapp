...
public class ContactUsActivity extends BaseActivity implements OnResponseListner {
    ...
    public void ivWhatsappClick() {
        String whatsAppMessage = RequestParamUtils.Testmessage + tvWhatsapp.getText().toString();
        try {
//            Uri uri = Uri.parse("smsto:" + "9924381831");
...
//            startActivity(sendIntent);
            ...
            Uri uri = Uri.parse(RequestParamUtils.smsto + Constant.WHATSAPP);
            Intent i = new Intent(Intent.ACTION_SENDTO, uri);
            i.putExtra(RequestParamUtils.smsBody, whatsAppMessage);
            i.setPackage(RequestParamUtils.whatsAppPackage);
            startActivity(i);
        } catch (Exception e) {
